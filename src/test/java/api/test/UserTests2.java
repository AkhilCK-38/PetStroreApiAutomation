...
public class UserTests2 {
	...
	public void setup()
	{
	 ...
	 public void testPostUser()
	 {
		...
		Response response= UserEndpoints2.createUser(userPayloadData);
	 ...
	 public void testGetUser()
	 {
		 ...
		 Response response=UserEndpoints2.getUser(this.userPayloadData.getUsername());
	 ...
	 public void testUpdateUser()
	 {
		 ...
		 Response response=UserEndpoints2.updateUser(this.userPayloadData.getUsername(), userPayloadData);
		 ...
		 Response responseAfterUpdation=UserEndpoints2.getUser(this.userPayloadData.getUsername());
	 ...
	 public void testdeleteUser()
	 {
		...
		Response response= UserEndpoints2.deleteUser(this.userPayloadData.getUsername());
